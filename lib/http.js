  ...
  function _Class(api_options){
    ...
    this.run_request = function(options){
      ...
      if(request.auth_error) {
        request.callback(null, new Error(request.auth_error.error));
        return;
      }
      var api_request = https.request(request.req_options, function(api_res) {
        ...
        if (api_res.statusCode <= 210 || api_res.statusCode == 422) {  
          ...
          api_res.on("end",function(chunk) {
            try{
              ...
              request.callback(null, new errors.ClientError(errorBody.error,api_res.statusCode,errorBody));
            } catch(e){
